...
public class Task {
    public static void go(){
        try {
            ...
            System.out.println("GENERATE HEAD");
            ...
            System.out.println("GENERATE POST");
...
//                    "GET"));
            ...
            System.out.println("GENERATE VKAPI");
            ...
            sectionRESTserver.add(UrlChecker.sendRequest("https://jsonplaceholder.typicode.com/posts/2",
                    "DELETE"));
            System.out.println("GENERATE REST");
            ...
            File html = new File("./src/main/resources/templates","index.html");
            ...
            fileWriter.close();
            System.out.println("GENERATE FILE HTML");
